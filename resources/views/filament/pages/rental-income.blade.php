<x-filament::page>
    <form wire:submit.prevent="submit" class="w-full">
        @csrf
        <div
            class=" px-6 block bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 mb-6 pb-6">
            ...
            <div class="mb-6 pt-4">
                <h2 class="block mr-4 mt-4 mb-1 text-xl font-medium text-gray-900 dark:text-white">Units:
                    {{ $units->count() }}</h2>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                @foreach ($units as $index => $unit)
                    ...
                    {{-- @php
                        ...
                        @endphp --}}
                    <div
                        class="mb-4 bg-white border border-blue-200 rounded-lg   dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 p-0">
                        <div class="flex justify-between">
                            <h2 wire:model="rental_income.{{ $index }}.tenant_name"
                                class="ml-4 block mr-4 mt-4 mb-1 text-base font-medium text-blue-600 dark:text-white">
                                {{ $unit->name }}</h2>
                        ...
                        <div class="grid grid-cols-1 lg:flex ml-4 p-4 gap-4">
                            ...
                            <div class="flex">
                                <div class="flex items-center pr-4">
                                    ...
                                    <input wire:model="rental_income.{{ $index }}.occupied" type="checkbox"
                                        value=""
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                </div>
                                <div class="flex items-center pr-4">
                                    <label for="rental_income.{{ $index }}.hasParking"
                                        class="mr-2 text-xs font-normal text-gray-900 dark:text-gray-300">Has
                                        Parking</label>
                                    <input wire:model="rental_income.{{ $index }}.hasParking" type="checkbox"
                                        value=""
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                </div>
                            </div>
