                    ...
                    <div class="w-full p-8 lg:w-6/12">
                        ...
                        <div>
                            <p
                                ...
                                Streamline Your Operations and Maximize Returns with Quarenta.
                            </p>
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mx-auto max-w-2xl lg:text-center">
                ...
                <p class="mb-8 w-full font-medium leading-snug text-gray-700 dark:text-gray-300">
                    ...
                    discover how Quarenta can transform your property ownership experience.
                </p>
            </div>
                    ...
                    <div class="relative overflow-hidden rounded-3xl">
                        ...
                        <div
                            ...
                            <h3 class="text-md mb-4 font-bold leading-snug text-black">
                                "I couldn't be happier with the services provided by Quarenta. As a first-time
                                landlord, I was overwhelmed by the responsibilities that come with managing a rental
                                property. However, Quarenta made the entire process seamless and stress-free.
                                Their user-friendly platform allowed me to easily track rental payments, access
                                financial reports, and communicate with my tenants. The team at Quarenta is highly
                                responsive, addressing any concerns or issues promptly. Their professionalism and
                                attention to detail have exceeded my expectations. Thanks to Quarenta, I am now a
                    ...
                    <div class="relative overflow-hidden rounded-3xl">
                        ...
                        <div
                            ...
                            <h3 class="text-md mb-4 font-bold leading-snug text-black">
                                ...
                                efficient rental management service was crucial for my success. I stumbled upon Quarenta
                                ...
                                late rent payments, vacancies, or maintenance emergencies. With Quarenta, I have
                    ...
                    <div class="relative overflow-hidden rounded-3xl">
                        ...
                        <div
                            ...
                            <h3 class="text-md mb-4 font-bold leading-snug text-black">
                                ...
                                discovered Quarenta, my life as a landlord has become so much easier. Their rental
                                ...
                                requests, and even legal matters with utmost professionalism. Thanks to Quarenta,
            ...
            <div class="-m-4 flex flex-wrap items-center justify-between py-6">
                ...
                <div class="w-auto p-4">
                    <p class="text-sm font-medium text-gray-600 dark:text-gray-400">
                        Copyright © 2023 Quarenta. All Rights Reserved
                    </p>
                </div>
                <div class="w-auto p-4">
